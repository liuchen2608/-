...
export const AI_CONVERSATION_NOTICE = "为了进行连续需求对话，大象阿宝会将你本次输入的原文、当前对话最近最多 12 条可用消息，以及你主动保存的生活偏好发送给 DeepSeek API。不会附带账号身份、旧医疗档案或其他对话。请勿输入敏感个人信息。是否同意？你可以在数据与隐私中撤回；撤回不影响已经发出的请求。";
